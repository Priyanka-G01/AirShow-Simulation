...
void front()
{
	...
	output(250,650,"UNIVERSITY VISVESVARAYA COLLEGE OF ENGINEERING",fonts[2]);
	glColor3f(1.0,1.0,0.0);
	...
	output(250,350,"1] Priyanka G",fonts[2]);
	output(650,350,"3] Shreekanth Dash",fonts[2]);
...
void help()
{
	...
	glColor3f(0.5,0.2,0.6);
	output(600,60,"[ Dept. of CSE, UVCE ]",fonts[0]);
}
void intro()
{
	glColor3f(0.8,0.1,0.2);
